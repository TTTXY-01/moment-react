...
class UserAll extends Component {
  ...
  scroll = () => {
    ...
    if (document.body.scrollTop >= document.body.scrollHeight - document.documentElement.clientHeight) {
      this.setState({
        ...
        let interFace = '/feed/getMyPost.php' + location.search + '&pageSize=10&client=web&minId=' + this.state.data[this.state.minIndex].content.contentId
  ...
  componentDidMount() {
    this.ajaxData('/feed/getMyPost.php' + location.search + '&pageSize=10&client=web&minId=')
