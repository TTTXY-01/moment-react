...
class UserArticle extends Component {
  ...
  scroll = () => {
    ...
    if (document.body.scrollTop >= document.body.scrollHeight - document.documentElement.clientHeight) {
      this.setState({
        ...
        let interFace = '/article/listByUid.php' + location.search + '&pageSize=10&client=web&minId=' + this.state.data[this.state.minIndex].content.contentId
  ...
  componentDidMount() {
    this.ajaxData('/article/listByUid.php' + location.search + '&pageSize=10&client=web&minId=')
              ...
              <div className='card-read-cpt' key={index.toString()}>
                ...
                <div className='card-item'>
                  ...
                  <div className='card-others'>
                    <span className='card-type'><a href='read.html' target='_blank'>阅读</a></span>
